...
_ALLOWED = {
    ...
    "review_requested": {"review_running", "changes_requested", "approved", "needs_decision", "terminated"},
    "review_running": {"changes_requested", "approved", "needs_decision", "done", "error", "terminated"},
